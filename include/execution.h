...
/*                                                   +#+                      */
/*   Created: 2023/04/04 11:49:35 by dmonfrin      #+#    #+#                 */
/*   Updated: 2023/04/04 11:55:37 by dmonfrin      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
/* draw_scene.c */
void			draw_scene(t_exe_info *info, t_wall_pos *wall,
					int ray, double angle);
/* execution_init.c */
...
/* rays_calc.c*/
void			find_vert_wall(t_exe_info *img, t_wall_pos *w_pos,
					double angle);
void			find_horiz_wall(t_exe_info *img, t_wall_pos *w_pos,
					double angle);
/* rays_utils.c*/
